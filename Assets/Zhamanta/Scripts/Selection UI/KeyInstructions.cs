...
public class KeyInstructions : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        SetUpInstruction(_p1ChooseText, _p1ReadyText, _p1BackText, _p1InputMap);
        SetUpInstruction(_p2ChooseText, _p2ReadyText, _p2BackText, _p2InputMap);
    }

    private void SetUpInstruction(TMP_Text chooseText, TMP_Text readyText, TMP_Text backText, InputActionMap map)
    {
        ...
        backText.text += map.FindAction("SkillOne").GetBindingDisplayString();
    }
}
